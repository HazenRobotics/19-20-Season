...
@Autonomous(name="Autonomous-FoundationRight")
//@disabled
public class AutonomousFoundationRight extends LinearOpMode
{
    //======================================================
    DcMotor leftMotor;
    DcMotor rightMotor;
    ...
    final double RIGHT_CLAPPER_HOME = 0.61;
    final double LEFT_CLAPPER_EXTENDED = 0.38;
    final double RIGHT_CLAPPER_EXTENDED = 1.0;
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        rightClapper.setPosition(0.5);

        robot.turn(85,1,false,false);
        sleep(250);

        robot.clapper(true);
        robot.move(5, 1, false);
        sleep(250);
