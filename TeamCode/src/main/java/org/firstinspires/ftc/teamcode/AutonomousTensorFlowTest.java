...
*/
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        telemetry.addData("hooks", "starting");
        telemetry.update();
        robot.hooks(true);
        telemetry.addData("hooks", "finished");
        telemetry.update();

        telemetry.addData("clappers", "starting");
        telemetry.update();
        robot.clapper(true);
        telemetry.addData("clappers", "finished");
        telemetry.update();
        sleep(100);
        ...
        */
        ...
        telemetry.addData("move", "starting");
        telemetry.update();
